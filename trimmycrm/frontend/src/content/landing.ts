...
export const productFeatures = [
  ...
  },
  {
    ...
    text: "Клиент сам выбирает услугу, вариант, мастера и свободное время — круглосуточно.",
    tone: "white",
  },
  {
    icon: "people",
  ...
  },
  {
    ...
    text: "Email уже в базовом тарифе, SMS и Telegram — когда салон готов расти дальше.",
    tone: "lime",
  },
];
...
export const workflow = [
  {
    ...
    text: "Название, адрес, график, услуги и мастера — всё заполняется в одном кабинете.",
  },
  {
    step: "2",
...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "Мы вручную создаём отдельный визуальный шаблон для вашего салона. Вы продолжаете менять контент в той же CRM, а стоимость разработки — 20 000 ₽ единоразово.",
  },
  {
